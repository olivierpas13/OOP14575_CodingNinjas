 ...
 */
public class FrmDeleteTask extends javax.swing.JFrame {
    private Point mPoint;

    /**
     * Creates new form FrmDeletetask
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDeleteTask.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDeleteTask().setVisible(true);
            }
        });
    }
