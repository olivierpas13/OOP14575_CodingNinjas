...
public class GPTHandler {
    ...
    // 
    public static String getDailyMessage(ArrayList<Task> tasks) {
...
//        String message = "Explain what the gamma function is, only with words, nto even one symbol that couldnt be seen on cmd, dont mention ur limit";
