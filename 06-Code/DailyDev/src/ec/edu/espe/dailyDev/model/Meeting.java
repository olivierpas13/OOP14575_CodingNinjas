...
public class Meeting {
    ...
    private Meeting(String title, Date startTime, Date endTime, List<User> participants, Date creationDate) {
    ...
    public String toString() {
        return "Meeting{" + "id=" + id + ", title=" + title + ", startTime=" + startTime + ", endTime=" + endTime + ", participants=" + participants + ", creationDate=" + creationDate + '}';
    }
        ...
        do {
            option = MenuUtils.getUserOption("Task", meetingOptions);

            switch (option) {
                case 1 -> create();
                case 2 -> show();
                case 3 -> showMeetingTodays();
                case 4 -> complete();
                case 5 -> delete();
    ...
    public static void showMeetingTodays() {
        System.out.println("hola");
    }    
